...
今回のプログラムではそれを実現するために，あらかじめメモリ上に400バイトの領域（int型100個分）を確保し，
その中に見つけた素数を格納していく，という手段をとった．

もう一つの違いとしては，見つけた素数を全て表示するのではなく，
ユーザーの入力情報をもとに任意の素数のみを表示する，という点である．
